...
BEVERAGES = [
    ...
    # Iced Drinks (ECAM450 Eletta Explore Series)
    (0x32, "cold_americano",       "Cold Americano",        "mdi:coffee-outline"),
    (0x33, "cold_cappuccino",      "Cold Cappuccino",       "mdi:coffee-outline"),
    (0x34, "cold_latte_macchiato", "Cold Latte Macchiato",  "mdi:coffee-outline"),
    (0x36, "cold_flat_white",      "Cold Flat White",       "mdi:coffee-outline"),
    (0x37, "cold_milk",            "Cold Milk",             "mdi:cup-water"),
    (0x38, "cold_caffelatte",      "Cold Caffe Latte",      "mdi:coffee-outline"),
